...
const en = {
  ...
  a11y: {
    ...
    openHeaderTools: "Open résumé, contact and display options",
    closeHeaderTools: "Close résumé, contact and display options",
...
const fr = {
  ...
  a11y: {
    ...
    openHeaderTools: "Ouvrir le CV, le contact et les options d’affichage",
    closeHeaderTools: "Fermer le CV, le contact et les options d’affichage",
