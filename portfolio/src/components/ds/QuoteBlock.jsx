 ...
 * Reserved for case openers, section punctuation, editorial accents.
 * Reconstructed from the design-system spec (components/core/QuoteBlock.jsx).
 */
const sizes = {
...
export function QuoteBlock({ quote, attribution, context, size = "md", style, ...props }) {
  return (
    <figure style={{ margin: 0, display: "flex", flexDirection: "column", gap: "16px", ...style }} {...props}>
      <blockquote
        style={{
