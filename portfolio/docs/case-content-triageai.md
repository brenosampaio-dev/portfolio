...
| **Timeline** | 6 weeks |
| **Tools** | Figma, Claude (research + copy), Next.js / Tailwind (portfolio implementation) |
...
Claude was used as a thinking partner for problem framing: generating edge cases, stress-testing assumptions, mapping analogous products and their failure modes. Error state copy, empty state labels, and system messages were drafted with Claude and refined manually.

No screens were generated by AI. All design decisions are the designer's.
